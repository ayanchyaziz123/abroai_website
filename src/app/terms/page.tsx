...
export const metadata: Metadata = {
  title: "Terms of Service — AbroAI",
  description: "The terms that govern your use of AbroAI.",
};
...
export default function TermsOfService() {
  return (
    <div className="min-h-screen bg-ground">
      <div className="pointer-events-none fixed inset-0 [background:radial-gradient(120%_60%_at_50%_-10%,rgba(124,58,237,0.10),transparent)]" />
      <main className="relative mx-auto max-w-2xl px-5 py-16 sm:py-20">
        ...
        <div className="mt-10 space-y-10 text-[15px] leading-relaxed text-ink-dim">
          <p>
            These Terms of Service (&ldquo;Terms&rdquo;) govern your use of AbroAI (the
            &ldquo;App&rdquo;). By creating an account or using the App, you agree to these Terms.
            If you don&apos;t agree, please don&apos;t use AbroAI.
          </p>

          <Section title="1. Who can use AbroAI">
            <P>
              You must be at least 18 years old and able to form a binding contract to use AbroAI.
              You&apos;re responsible for keeping your account credentials secure and for
              everything that happens under your account.
            </P>
          </Section>

          <Section title="2. What AbroAI is">
            <P>
              AbroAI is a community platform connecting immigrants with job listings, housing,
              marketplace items, rideshare, local events, and a directory of verified lawyers and
              doctors. Except for the lawyer/doctor directory (which is curated by AbroAI through
              manual admin review), all listings are posted by users, not by AbroAI. We don&apos;t
          ...
          <Section title="3. Your content">
            <P>
              ...
              posting, you grant AbroAI a license to store, display, and distribute that content
          ...
          <Section title="5. Verified professionals (lawyers & doctors)">
            <P>
              Attorneys and doctors listed in the App are added and reviewed by AbroAI
              ...
              added, but AbroAI is not a law firm or medical provider, doesn&apos;t provide legal
              or medical advice, and connecting with someone through this directory doesn&apos;t
              create a professional relationship with AbroAI. Always independently verify
          ...
          <Section title="9. Disclaimers">
            <P>
              AbroAI is provided &ldquo;as is.&rdquo; We don&apos;t guarantee that any job, housing
              ...
              or in-person meeting arranged through AbroAI.
            </P>
          </Section>

          <Section title="10. Limitation of liability">
            <P>
              To the fullest extent permitted by law, AbroAI is not liable for any indirect,
          ...
          <Section title="11. Changes to these Terms">
            <P>
              ...
              effort to notify you in-app. Continuing to use AbroAI after changes take effect
